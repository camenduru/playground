...
RUN aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/camenduru/TostModels/resolve/main/models/checkpoints/playground-v2.5-1024px-aesthetic.fp16.safetensors -d /content/ComfyUI/models/checkpoints -o model.safetensors
